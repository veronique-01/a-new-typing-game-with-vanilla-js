const Keyboard = {
    ...
    init() {
        ...
        document.addEventListener("keydown", (e) => {
            ...
            const virtualKey = document.querySelector(`.keyboard__key[data-key="${normalizedKey}"]`);

            if (virtualKey) {
                virtualKey.classList.add("keyboard__key--active");
                setTimeout(() => {
                    virtualKey.classList.remove("keyboard__key--active");
                }, 150);
            }
        });
    },
